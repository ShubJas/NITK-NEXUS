...
const handleSearch = async () => {
  try {
    ...
    const response = await axios.get(`/api/v1/universities/search?${params.toString()}`);
    setFilteredUniversities(response.data.data);
  } catch (err) {
    setError(err.message);
  } finally {
        ...
        <div className="bg-white rounded-lg p-4 shadow-inner flex-grow flex items-center justify-center">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-2">
              <span className="font-bold text-blue-600">{filteredUniversities.length}</span> universities match your criteria
            </p>
    ...
    <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
      ...
      <div className="overflow-y-auto" style={{maxHeight: '500px'}}>
        {filteredUniversities.slice(0, 10).map((uni) => (
          <div key={uni._id} className="p-4 border-b border-gray-100 hover:bg-blue-50 transition-colors">
            <div className="flex items-start">
              ...
              />
              <div className="flex-grow">
                <h5 className="font-bold text-gray-900">{uni.name}</h5>
