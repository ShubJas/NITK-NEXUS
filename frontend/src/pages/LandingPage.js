          ...
          <div className="grid md:grid-cols-3 gap-16 max-w-6xl mx-auto">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden transition-transform hover:scale-105 relative group">
              <div className="p-8 pb-24">
                <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-6">
                  <i className="fas fa-book text-blue-500 text-2xl" />
                </div>
                ...
                <button
                  className="w-full bg-blue-600 text-white py-3 !rounded-button hover:bg-blue-700 transition-colors"
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden transition-transform hover:scale-105 relative group">
              <div className="p-8 pb-24">
                ...
                <button
                  className="w-full bg-green-600 text-white py-3 !rounded-button hover:bg-green-700 transition-colors"
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden transition-transform hover:scale-105 relative group">
              <div className="p-8 pb-24">
                ...
                <button
                  className="w-full bg-purple-600 text-white py-3 !rounded-button hover:bg-purple-700 transition-colors"
