          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex-1 flex items-center justify-start space-x-8">
              ...
              <nav className="hidden md:flex items-center space-x-12 backdrop-blur-sm">
                ...
                <button
                  onClick={() => document.getElementById('exams').scrollIntoView({ behavior: 'smooth', block: 'start' })}
                  className="text-custom font-medium transition-colors flex-1 text-center hover:opacity-80 bg-transparent border-none cursor-pointer"
                >
                  Exams
                </button>
                <button
                  onClick={() => document.getElementById('universities').scrollIntoView({ behavior: 'smooth', block: 'start' })}
                  className="text-custom font-medium transition-colors flex-1 text-center hover:opacity-80 bg-transparent border-none cursor-pointer"
                >
                  Universities
                </button>
                ...
                <button
                  // onClick={() => document.getElementById('community').scrollIntoView({ behavior: 'smooth', block: 'start' })}
                  className="text-custom font-medium transition-colors flex-1 text-center hover:opacity-80 bg-transparent border-none cursor-pointer"
                >
                  Community
                </button>
